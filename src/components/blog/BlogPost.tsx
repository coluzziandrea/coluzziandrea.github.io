import { PostWithContent } from '@/model/post'
import Link from 'next/link'
import { FaCirclePlay } from 'react-icons/fa6'

export const BlogPost = (blogPost: PostWithContent) => {
  const date = new Date(blogPost.date).toLocaleDateString('en-US', {
    year: 'numeric',
    month: 'long',
    day: 'numeric',
  })
              ...
              <div className="space-y-6">
                <div className="flex flex-col space-y-2 inner">
                  <Link
                    ...
                    href={`/blog/${blogPost.year}/${blogPost.slug}`}
                  >
